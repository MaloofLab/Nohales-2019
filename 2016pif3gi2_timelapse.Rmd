...
p.growthrate <- p.growthrate + xlim(72,max(tl.rates3$after.stratification_hr))
#p.growthrate <- p.growthrate + coord_cartesian(ylim=c(-0.001,0.005))
p.growthrate
ggsave(p.growthrate,file="Maria_pif3gi3_timelapse_v3.png",dpi=300,width=11,height=8) 
```
