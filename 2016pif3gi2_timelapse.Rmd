...
# change pixel into mm (under construction)
...
# tl.rates <- tl.rates[complete.cases(tl.rates[,-7]),]  #remove rows with no data.(from J). error (Kazu)
...
p.growthrate
ggsave(p.growthrate,file="Marian_pif3gi3_timelapse.png",dpi=300,width=11,height=8) # needs to clean graph
